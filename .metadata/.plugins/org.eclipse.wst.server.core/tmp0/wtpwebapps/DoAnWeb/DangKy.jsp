...
<div class="wrapper" id="wrap">
  <div class="inner-warpper text-center">
    ...
    <form action="XuLyDangKy" method="post">
      ...
      <div class="input-group">
        <label class="palceholder" ><%=showlanguage.get("DangKy.PassWord")%></label>
      ...
      <div class="input-group">
        ...
        <input class="form-control" name="firstname" id="userPassword1" type="text" placeholder="" />
        <span class="lighting"></span>
      </div>
      <div class="input-group">
        <label class="palceholder" for="userPassword"><%=showlanguage.get("DangKy.Email")%></label>
        <input class="form-control" name="email" id="userPassword2" type="email" placeholder="" />
        <span class="lighting"></span>
      </div>
      <div class="input-group">
        <label class="palceholder" for="userPassword"><%=showlanguage.get("DangKy.Telephone")%></label>
        <input class="form-control" name="telephone" id="userPassword3" type="text" placeholder="" />
      ...
      <div class="input-group">
        ...
        <input class="form-control" name="address" id="userPassword4" type="text" placeholder="" />
        <span class="lighting"></span>
      </div>

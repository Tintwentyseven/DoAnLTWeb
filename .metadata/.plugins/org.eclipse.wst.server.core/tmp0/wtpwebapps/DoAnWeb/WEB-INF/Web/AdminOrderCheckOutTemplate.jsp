        ...
        <!-- Content wrapper -->
         <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <h5 class="card-header">List of Order checkout</h5>
              			<p>Số lượng đơn hàng đã thanh toán:${numberCheckOut}</p>
              			<div class="col-md-6 pb-4">
                        <div class="d-flex">
                            <select class="form-control" onchange="location = this.value;">
                                <option hidden>Featured</option>
                                <option value="XuLyHDOrder?action=A1">Tất cả</option>
                                
                        
                          
                            <optgroup label = "Gía cả">
                                <option value="XuLyHDOrder?action=L100A1">Nhỏ hơn 100.00</option>
                                <option value="XuLyHDOrder?action=L100300A1">Từ 100.00 tới 300.00</option>
                                <option value="XuLyHDOrder?action=H300A1">Lớn hơn 300.00</option>
              		 ...
              		 <br>
              		 <a href="XuLyHDOrder?action=deleteallCheckOut"><button class="btn btn-primary me-2">Remove all</button></a>
              		 <br>
              		<form action="XuLyRemoveCheckOrderCheckOut" method="POST">
              ...
              <div class="table-responsive text-nowrap">
                <table class="table" id="data" border="1">
                  <thead>
                    <tr>
                    <th></th>
                      <th>Orderid</th>
                  ...
                  <tbody class="table-border-bottom-0">
                   <c:if test="${!empty sessionScope.numberCheckOuts}">
  <c:forEach var="ch" items="${CheckOuts}"> 

						<tr>
							  <td><input type="checkbox" name="selectedCheckOuts" value="${ch.orderid}" /></td>
							<td>${ch.orderid}</td>
							<td><c:out value="${ch.country}" /></td>
							<td> <c:out value="${ch.phonenumber}" />
  
</td>
							<td><c:out value="${ch.transfers}"/></td>
							<td><c:out value="${ch.checkoutdate}" /></td>
							<td><c:out value="${ch.statusch}" /></td>
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="XuLyHDOrderUpdateStatus?orderid=${ch.orderid}"><i class="bx bx-edit-alt me-1"></i>
                              Update</a>
                            <a class="dropdown-item" href="XuLyHDOrder?action=deleteCheckOut&orderid=${ch.orderid}&username=${ch.username}"><i class="bx bx-edit-alt me-1"></i>
                              Delete</a>
...
<button onclick="exportTableToExcel('data', 'checkout_data')">Export Table Data To Excel File</button>

...
<p style="position:relative;top:8px">Chào ${sessionScope.userloginA.name}/<a href="DangNhap.jsp" style="text-decoration:none">LogOut</a></p>    </c:when>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
<input type="text" readonly  class="form-control"  name="caId"  value="${categoryE.id}" required placeholder="">
<span style="color:red;font-size:10px">${error}</span>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
<input type="text" class="form-control"  name="caName" value="${categoryE.caname}"  required >
      </div>
    </div>

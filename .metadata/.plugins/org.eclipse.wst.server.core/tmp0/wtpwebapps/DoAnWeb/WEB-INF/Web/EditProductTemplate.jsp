...
<c:set var="productE" value="${dao.getAllProductById(param.editproductid)}"/>
  <!-- Layout wrapper -->
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item lh-1 me-3">
                <c:choose>
    <c:when test="${!empty sessionScope.userloginA.name}">
...
<span style="color:red;font-size:10px">${error}</span>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
<input type="text" class="form-control"  name="productName" value="${productE.proname}"  required >
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="file" alt="Ko hiện được" class="form-control"   name="productImg" value="${productE.image}"  required >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Price</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control"  name="productPrice" required value="${productE.price}"  >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">AvailNumber</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control"  name="productNumber" required value="${productE.availnumber}"  >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">CategoryId</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control"  name="productCaid" required value="${productE.categoryid}"  >
      </div>
    </div>

            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card mb-4">
                  ...
                  <hr class="my-0" />
                  <div class="card-body">
                    <form method="post"  action="XuLyHDUserEdit" >
                      <div class="row">
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">Id</label>
                          <input class="form-control" type="text" id="firstName"  name="useridE" readonly value="${euser.userid}"
                            autofocus />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">UserName</label>
                          <input class="form-control" type="text" id="firstName"  name="usernameE" value="${euser.userName}"
                            autofocus />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">PassWord</label>
                          <input class="form-control" type="password" id="firstName"  name="passE" value="${euser.password}"
                            autofocus />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">First Name</label>
                          <input class="form-control" type="text" id="firstName" name="firstnameE" value="${euser.name}"
                            autofocus />
                        </div>
                        
                        <div class="mb-3 col-md-6">
                          <label for="email" class="form-label">E-mail</label>
                          <input class="form-control" type="email" id="email" name="emailE" required value="${euser.email}"
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="phoneNumber" name="telephoneE" value="${euser.phonenumber}" class="form-control"
                               />
                          </div>
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="address" class="form-label">Address</label>
                          <input type="text" class="form-control" id="address" name="addressE" value="${euser.address}" />
                        </div>

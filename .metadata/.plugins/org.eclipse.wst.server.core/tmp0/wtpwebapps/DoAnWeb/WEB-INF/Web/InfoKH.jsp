  ...
  <c:forEach var="users" items="${info}"> 
						...
						<tr>
							...
							<td><c:out value="${users.address}" /></td>
							 <td><a href="XuLyEditUser?edituserid=${users.userid}" style="text-decoration:none">Edit</a></td>
							<td><a href="XuLyAdminUser?userid=${users.userid}" style="text-decoration:none">Remove</a></td> 

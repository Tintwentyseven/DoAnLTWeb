...
<p style="position:relative;top:8px">Chào ${sessionScope.userloginA.name}/<a href="DangNhap.jsp" style="text-decoration:none">LogOut</a></p>    </c:when>
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <h5 class="card-header">List of Product</h5>
              		 ...
              		 <a href="XuLyHDProductAdd"><button class="btn btn-primary me-2">Add new product</button></a>
              		 <br>
              		 <a href="XuLyHDProduct?action=deleteall"><button class="btn btn-primary me-2">Remove all</button></a>
              		 <br>
              		<form action="XuLyRemoveCheckProduct" method="POST">
  ...
  <c:forEach var="pro" items="${ProAdmin}"> 
						...
						<tr>
							  <td><input type="checkbox" name="selectedProducts" value="${pro.id}" /></td>
							<td>${pro.id}</td>
							<td><c:out value="${pro.proname}" /></td>
							<td style="white-space: pre-wrap;">
  <c:out value="${pro.descriptions}" />
</td>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="XuLyHDProductEdit?editproductid=${pro.id}">
    <i class="bx bx-edit-alt me-1"></i> Edit
</a>
                         
                          
                            <a class="dropdown-item" href="XuLyHDProduct?action=delete&productid=${pro.id}"><i class="bx bx-edit-alt me-1"></i>
                              Delete</a>
...
<button onclick="exportTableToExcel('tabledata', 'product_data')">Export Table Data To Excel File</button>
              <!-- / Content -->

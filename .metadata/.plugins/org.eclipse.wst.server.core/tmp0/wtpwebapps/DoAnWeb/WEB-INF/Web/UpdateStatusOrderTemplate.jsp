            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card mb-4">
                  ...
                  <hr class="my-0" />
                  <div class="card-body">
                   <form class="form-horizontal" action="XuLyHDOrderUpdateStatus" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">ID</label>
      <div class="col-sm-10">
<input type="text" readonly  class="form-control"  name="orderId"  value="${orderE.orderid}" required placeholder="">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <select id="statusorder" class="form-control" name="statusorder">
		                <option value="${orderR.statuscheckout}">${orderR.statuscheckout}</option>    

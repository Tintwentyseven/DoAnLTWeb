            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card mb-4">
                  ...
                  <hr class="my-0" />
                  <div class="card-body">
                    <form method="post"  action="XuLyHDCategoryAdd" >
                      <div class="row">
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">Id</label>
                          <input class="form-control" type="text" id="firstName" name="caId"  required
                            autofocus />
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <input class="form-control" type="text" id="firstName"  name="caName"  required
                            autofocus />
                        </div>

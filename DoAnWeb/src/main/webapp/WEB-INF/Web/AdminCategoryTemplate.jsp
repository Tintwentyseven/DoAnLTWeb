          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <h5 class="card-header">List of Category</h5>
              			<p>Số lượng danh mục:${numberCa}</p>
              			<div class="col-md-6 pb-4">
                        <div class="d-flex">
                            
                        </div>
                    </div>
                      <a href="XuLyHDCategoryAdd"><button class="btn btn-primary me-2">Add new category</button></a>
                      <br>
                      <a href="XuLyHDCategory?action=deleteall"><button class="btn btn-primary me-2">Remove all</button></a>
                      <br>
              		<form action="XuLyRemoveCheckCategory" method="POST">
              ...
              <div class="table-responsive text-nowrap">
                <table class="table" id="tabledata">
                  ...
                  <c:if test="${!empty sessionScope.numberCa}">
  <c:forEach var="ca" items="${CaAdmin}"> 

						<tr>
						 <td><input type="checkbox" name="selectedCategorys" value="${ca.id}" /></td>
						<td>${ca.id}</td>
						<td><c:out value="${ca.caname}" /></td>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="XuLyHDCategoryEdit?editcaid=${ca.id}"><i class="bx bx-edit-alt me-1"></i>
                              Edit</a>
                           
                         
                          
                            <a class="dropdown-item" href="XuLyHDCategory?action=delete&caid=${ca.id}"><i class="bx bx-edit-alt me-1"></i>
                              Delete</a>

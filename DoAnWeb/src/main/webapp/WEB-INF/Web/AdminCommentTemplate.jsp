        ...
        <!-- Content wrapper -->
         <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <h5 class="card-header">List of Comment</h5>
              			<p>Số lượng comment:${numberCo}</p>
              			<div class="col-md-6 pb-4">
                        <div class="d-flex">
                            <select class="form-control" onchange="location = this.value;">
                            <option hidden>Featured</option>
                               
                                <option value="XuLyAdminCommentMoiNhat">Mới nhất</option>
                                <option value="XuLyAdminCommentCuNhat">Cũ nhất</option>
              		 ...
              		 <br>
              		 <a href="XuLyHDComment?action=deleteall"><button class="btn btn-primary me-2">Remove all</button></a>
              		 <br>
              			<form action="XuLyRemoveCheckComment" method="POST">
              ...
              <div class="table-responsive text-nowrap">
                <table class="table" id="tabledata" border="1">
                  ...
                  <tbody class="table-border-bottom-0">
                   <c:if test="${!empty sessionScope.numberCo}">
  <c:forEach var="Co" items="${CoAdmin}" varStatus="loop"> 

						<tr>
							<td><input type="checkbox" name="selectedComments" value="${Co.getCommentdate()}" /></td>
							<td>${loop.count}</td>
							<td><c:out value="${Co.getProductname()}" /></td>
							<td >
  <c:out value="${Co.getUsername()}" />
</td>
							<td>${Co.getDetailcomment() }</td>
							<td><c:out value="${Co.getCommentdate()}" /></td>
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="XuLyHDComment?action=delete&time=${Co.getCommentdate()}"><i class="bx bx-edit-alt me-1"></i>
                              Delete</a>
...
<button onclick="exportTableToExcel('tabledata', 'comment_data')">Export Table Data To Excel File</button>
              <!-- / Content -->

...
<body>
 ...
 <ul class="menu-sub">
              <li class="menu-item">
                <a href="XuLyDangNhap" class="menu-link">
...
<p style="position:relative;top:8px">Chào ${sessionScope.userloginA.name}/<a href="DangNhap.jsp" style="text-decoration:none">LogOut</a></p>    </c:when>
    ...
    <div id="piechart" style="width: 900px; height: 500px;position:relative;left:100px"></div>
    <div id="donutchart" style="width: 900px; height: 500px;position:relative;top:10px;left:100px"></div>
        ...
        <!-- Content wrapper -->
         <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <h5 class="card-header">List of Sell</h5>
              			<p>Số lượng sản phẩm bán được :${totalsell}</p>
              ...
              <div class="col-md-6 pb-4">
                        <div class="d-flex">
                            ...
                            <optgroup label = "Thứ tự">
                                <option value="XuLyHDOrder?action=MQuantity">Bán nhiều nhất</option>
                                <option value="XuLyHDOrder?action=LQuantity">Bán ít nhất</option>
                                <option value="XuLyHDOrder?action=MMoney">Bán giá lớn nhất</option>
                                <option value="XuLyHDOrder?action=LMoney">Bán giá nhỏ nhất</option>
              ...
              <div class="table-responsive text-nowrap">
                <table id="tabledata" class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    <c:if test="${!empty sessionScope.totalsell}">
  <c:forEach var="Sell" items="${listsell}">  

						<tr>
							
						<td><c:out value="${Sell.orderid}" /></td>
							<td><c:out value="${Sell.productname}" /></td>
							<td><c:out value="${Sell.quantity}" /></td>
							<td><c:out value="${Sell.totalprice}" /></td>
							<td><c:out value="${Sell.username}" /></td>
                    ...
                    <tr>
                      ...
                      <!--/ Responsive Table -->
<button onclick="exportTableToExcel('tabledata', 'user_data')">Export Table Data To Excel File</button>
              </div>
 ...
 <script>
  function exportTableToExcel(tableID, filename = '') {
    ...
    // Replace image sources with base64-encoded data
    var images = clonedTable.getElementsByTagName('img');
    for (var i = 0; i < images.length; i++) {
      var src = images[i].getAttribute('src');
      if (src.startsWith('data:image')) continue; // Already in base64 format
      ...
      images[i].setAttribute('src', base64Data);
    }
 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
    	    var coffee1 = ${coffeesell}; // Giả sử coffeesell1 là một biến số từ JSP
    	    var milktea1 = ${milkteasell};
    	    var juice1 = ${juicesell};

    	    var coffee2 = ${coffeesell2}; // Giả sử coffeesell2 là một biến số từ JSP
    	    var milktea2 = ${milkteasell2};
    	    var juice2 = ${juicesell2};
 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
    	  var coffee = ${coffeesell}; // Giả sử workHours là một biến số từ JSP
          var milktea = ${milkteasell};
          var juice = ${juicesell};
  ...
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChart);
      function drawChart() {
    	  var coffee = ${coffeem}; // Giả sử workHours là một biến số từ JSP
          var milktea = ${milkteam};
          var juice = ${juicem};
        var data = google.visualization.arrayToDataTable([
          ['Task', 'Hours per Day'],
          ['Coffee',     coffee],

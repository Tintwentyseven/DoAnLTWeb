...
<html lang="en" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default"
  data-assets-path="assetsforadmin/" data-template="vertical-menu-template-free">
...
<p style="position:relative;top:8px">Chào ${sessionScope.user.name}/<a href="DangNhap.jsp" style="text-decoration:none">LogOut</a></p>    </c:when>
    <c:otherwise>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                      <img src="assetsforadmin/img/avatars/1.png" alt="user-avatar" class="d-block rounded" height="100"
                  ...
                  <hr class="my-0" />
                  <div class="card-body">
                    <form method="post"  action="XuLyHDAdminEdit" >
                      <div class="row">
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">Id</label>
                          <input class="form-control" type="text" id="firstName"  name="useridA" readonly value="${admin.userid}"
                            autofocus />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">UserName</label>
                          <input class="form-control" type="text" id="firstName"  name="usernameA" readonly value="${admin.userName}"
                            autofocus />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">PassWord</label>
                          <input class="form-control" type="password" id="firstName"  name="passA" value="${admin.password}"
                            autofocus />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">First Name</label>
                          <input class="form-control" type="text" id="firstName" name="firstnameA" value="${admin.name}"
                            autofocus />
                        </div>
                        
                        <div class="mb-3 col-md-6">
                          <label for="email" class="form-label">E-mail</label>
                          <input class="form-control" type="email" id="email" name="emailA" required value="${admin.email}"
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="phoneNumber" name="telephoneA" value="${admin.phonenumber}" class="form-control"
                               />
                          </div>
                        </div>
                        <div class="mb-3 col-md-6">
                          <label for="address" class="form-label">Address</label>
                          <input type="text" class="form-control" id="address" name="addressA" value="${admin.address}" />
                        </div>
  ...
  <!-- Page JS -->
  <script src="assetsforadmin/js/pages-account-settings-account.js"></script>

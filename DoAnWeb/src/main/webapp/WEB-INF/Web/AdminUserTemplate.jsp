          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <h5 class="card-header">List of User</h5>
              			<p>Số lượng người dùng:${numberUser}</p>
              		 <a href="XuLyHDUser?action=deleteall"><button class="btn btn-primary me-2">Remove all</button></a>
              ...
              <div class="table-responsive text-nowrap">
                <table id="tabledata" class="table">
                  ...
                  <tbody class="table-border-bottom-0">
                    <c:if test="${!empty sessionScope.listU}">
  <c:forEach var="users" items="${listU}">  
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="XuLyHDUserEdit?Adminid=${users.userid}"><i class="bx bx-edit-alt me-1"></i>
                              Edit</a>
                           
                         
                          
                            <a class="dropdown-item" href="XuLyHDUser?action=delete&userid=${users.userid}"><i class="bx bx-edit-alt me-1"></i>
                              Delete</a>
                            <a class="dropdown-item" href="XuLyHDUser?action=capquyen&userid=${users.userid}"><i class="bx bx-edit-alt me-1"></i>
                              Cấp quyền</a>

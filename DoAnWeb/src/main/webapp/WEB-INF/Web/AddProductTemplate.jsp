            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="card mb-4">
                  ...
                  <hr class="my-0" />
                  <div class="card-body">
                    <form method="post"  action="XuLyHDProductAdd" >
                      <div class="row">
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">Id</label>
                          <input class="form-control" type="text" id="firstName"  name="productId" required
                            autofocus />
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <input class="form-control" type="text" id="firstName"  name="productName"  required
                            autofocus />
                        </div>
                        <div class="mb-3 col-md-12">
     <label for="descriptions" class="form-label">Descriptions</label>
     <textarea class="form-control" style="width: 1020px; height: 70px" name="productDes"></textarea>
   </div>
                        <div class="mb-3 col-md-6">
                          <label for="firstName" class="form-label">UrlImg</label>
                          <input class="form-control" type="file" alt="Ko hiện được" id="firstName" name="productImg"  required 
                            autofocus />
                        </div>
                        
                        <div class="mb-3 col-md-6">
                          <label for="email" class="form-label">Price</label>
                          <input class="form-control" type="text" id="email"  name="productPrice" required
                             />
                        </div>
                        <div class="mb-3 col-md-6">
                          <label class="form-label" for="phoneNumber">CategoryId</label>
                          <div class="input-group input-group-merge">
                            <span class="input-group-text">US (+1)</span>
                            <input type="text" id="phoneNumber" name="productCaid" required  class="form-control"
                               />

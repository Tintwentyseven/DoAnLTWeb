...
<p style="position:relative;top:8px">Chào ${sessionScope.userloginA.name}/<a href="DangNhap.jsp" style="text-decoration:none">LogOut</a></p>    </c:when>
        ...
        <!-- Content wrapper -->
         <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <h5 class="card-header">List of Admin</h5>
              			<p>Số lượng admin:${numberAdmin}</p>
 ...
 <c:forEach var="usersB" items="${listAB}">
    <tr>
        <td>${usersB.userid}</td>
        <td><c:out value="${usersB.name}" /></td>
        <td><c:out value="${usersB.email}" /></td>
        <td><c:out value="${usersB.phonenumber}" /></td>
        <td><c:out value="${usersB.address}" /></td>
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="XuLyHDAdminEdit?Adminid=${usersB.userid}">
 ...
 <c:forEach var="users" items="${listA}">
    <tr>
        <td>${users.userid}</td>
        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="XuLyHDAdminEdit?Adminid=${users.userid}">
                            <i class="bx bx-edit-alt me-1"></i> Edit
                        </a>
                       
                        <a class="dropdown-item" href="XuLyHDUser?action=thuhoi&adminid=${users.userid}">
                            <i class="bx bx-edit-alt me-1"></i> Thu hồi
                        </a>

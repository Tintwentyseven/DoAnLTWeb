...
/**
 * Servlet implementation class XuLyAdminCommentCuNhat
 */
@WebServlet("/XuLyAdminCommentCuNhat")
public class XuLyAdminCommentCuNhat extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public XuLyAdminCommentCuNhat() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Comments> list = dao.getAllOldestComment();

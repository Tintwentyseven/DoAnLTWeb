...
/**
 * Servlet implementation class XuLyRemoveCheckOrder
 */
@WebServlet("/XuLyRemoveCheckOrder")
public class XuLyRemoveCheckOrder extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public XuLyRemoveCheckOrder() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 for(String orderid:request.getParameterValues("selectedProducts")) {
